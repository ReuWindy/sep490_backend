...
public class CreateCustomerOrderTests {
    ...
    public void setUp() {
        // Mock dữ liệu cho Price, Customer và Product
         customerOrderDto = new CustomerOrderDto(1L,"0123456789","address", createOrderDetails());
    ...
    @Test
    public void OrderService_CreateCustomerOrder_ProductNotFound() {
        // Arrange
        when(customerRepository.findById(1L)).thenReturn(Optional.of(customer));
    ...
    @Test
    public void OrderService_CreateCustomerOrder_CustomerNotFound() {
        // Arrange
    ...
    @Test
    public void OrderService_CreateCustomerOrder_OrderDetailsDtoQuantityNegative(){
    ...
    @Test
    public void OrderService_CreateCustomerOrder_OrderDetailsDtoUnitPriceNegative(){
