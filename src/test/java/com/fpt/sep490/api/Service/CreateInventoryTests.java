...
public class CreateInventoryTests {
    ...
    public void setUp(){
        ...
        inventoryDto = new InventoryDto(1L,"INVENTORY-123",1,new Date(),warehouse,"Pending",Set.of(inventoryDetailDto),"username");
    }

    @Test
    public void createInventory_Success() {
    ...
    @Test
    public void createInventory_WarehouseNotFound() {
        // Arrange
    ...
    @Test
    public void createInventory_UserNotFound(){
        // Arrange
        when(warehouseRepository.findById(1L)).thenReturn(Optional.of(warehouse));
    ...
    @Test
    public void createInventory_PrroductWarehouseNotFound(){
    ...
    @Test
    public void createInventory_QuantityDiscrepancyCalculation() {
    ...
    @Test
    void createInventory_GenerateInventoryCode() {
        ...
        assertTrue(createdInventory.getInventoryCode().startsWith("INVENTORY-")); // Ví dụ mã code bắt đầu bằng "INV-"
    }
}
